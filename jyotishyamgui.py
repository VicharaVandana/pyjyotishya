...
#    Jan 28, 2023 09:47:41 PM IST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.LBL_lattitude_1.configure(text='''Longitude :''')
        self.lon = ttk.Entry(self.BirthData)
        self.lon.place(relx=0.559, rely=0.712, relheight=0.085, relwidth=0.134
                , bordermode='ignore')
