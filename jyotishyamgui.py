...
#    Feb 01, 2023 07:45:22 PM IST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.AppLabel.configure(text='''Jyotishyam App by Shyam Bhat''')
        _style_code()
        ...
        self.LBL_lattitude.place(relx=0.237, rely=0.61, height=25, width=107
                , bordermode='ignore')
        ...
        self.LBL_lattitude.configure(text='''Lattitude :''')
        self.lat = ttk.Entry(self.BirthData)
        self.lat.place(relx=0.434, rely=0.59, relheight=0.085, relwidth=0.254
                , bordermode='ignore')
        self.lat.configure(font="-family {Gadugi} -size 12")
        self.lat.configure(takefocus="")
        self.lat.configure(cursor="ibeam")
        self.lat_tooltip = \
        ToolTip(self.lat, '''In degrees(+ve for N and -ve for S)''')

        self.LBL_longitude = tk.Label(self.BirthData)
        self.LBL_longitude.place(relx=0.237, rely=0.712, height=25, width=118
                , bordermode='ignore')
        self.LBL_longitude.configure(activebackground="#f9f9f9")
        self.LBL_longitude.configure(anchor='w')
        self.LBL_longitude.configure(background="#d9d9d9")
        self.LBL_longitude.configure(compound='left')
        self.LBL_longitude.configure(disabledforeground="#a3a3a3")
        self.LBL_longitude.configure(font="-family {Comic Sans MS} -size 12")
        self.LBL_longitude.configure(foreground="#000000")
        self.LBL_longitude.configure(highlightbackground="#d9d9d9")
        self.LBL_longitude.configure(highlightcolor="black")
        self.LBL_longitude.configure(text='''Longitude :''')
        self.lon = ttk.Entry(self.BirthData)
        self.lon.place(relx=0.441, rely=0.712, relheight=0.085, relwidth=0.253
                , bordermode='ignore')
        self.lon.configure(font="-family {Gadugi} -size 12")
        self.lon.configure(takefocus="")
        self.lon.configure(cursor="ibeam")
        self.lon_tooltip = \
        ToolTip(self.lon, '''In degrees(+ve for E and -ve for W)''')

        self.LBL_timezone = tk.Label(self.BirthData)
        self.LBL_timezone.place(relx=0.237, rely=0.814, height=25, width=171
                , bordermode='ignore')
        ...
        self.timezone.place(relx=0.525, rely=0.814, relheight=0.085
        ...
        self.cmbGender = ttk.Combobox(self.BirthData)
        self.cmbGender.place(relx=0.797, rely=0.237, relheight=0.088
                , relwidth=0.181, bordermode='ignore')
        self.cmbGender.configure(state="readonly")
        self.value_list = ['Male','Female','Other',]
        self.cmbGender.configure(values=self.value_list)
        self.cmbGender.configure(font="-family {OCR A Extended} -size 11")
        self.cmbGender.configure(justify='center')
        self.cmbGender.configure(textvariable=self.Gender)
        self.cmbGender.configure(takefocus="")
        self.cmbGender_tooltip = \
        ToolTip(self.cmbGender, '''Select Your Gender''')

        self.lbl_gender = tk.Label(self.BirthData)
        self.lbl_gender.place(relx=0.644, rely=0.237, height=26, width=92
                , bordermode='ignore')
        self.lbl_gender.configure(activebackground="#f9f9f9")
        self.lbl_gender.configure(anchor='w')
        self.lbl_gender.configure(background="#d9d9d9")
        self.lbl_gender.configure(compound='left')
        self.lbl_gender.configure(disabledforeground="#a3a3a3")
        self.lbl_gender.configure(font="-family {Comic Sans MS} -size 12")
        self.lbl_gender.configure(foreground="#000000")
        self.lbl_gender.configure(highlightbackground="#d9d9d9")
        self.lbl_gender.configure(highlightcolor="black")
        self.lbl_gender.configure(text='''Gender :''')
        ...
        self.udLagnesh.place(relx=0.021, rely=0.124, height=33, width=433
                , bordermode='ignore')
        self.udLagnesh.configure(activebackground="#f9f9f9")
        ...
        self.udLagnesh.configure(highlightbackground="#d9d9d9")
        self.udLagnesh.configure(highlightcolor="black")
        ...
        self.udRashi.place(relx=0.021, rely=0.186, height=26, width=423
                , bordermode='ignore')
        self.udRashi.configure(activebackground="#f9f9f9")
        ...
        self.udRashi.configure(highlightbackground="#d9d9d9")
        self.udRashi.configure(highlightcolor="black")
        ...
        self.udNakshatra.place(relx=0.021, rely=0.248, height=26, width=443
                , bordermode='ignore')
        self.udNakshatra.configure(activebackground="#f9f9f9")
        ...
        self.udNakshatra.configure(highlightbackground="#d9d9d9")
        self.udNakshatra.configure(highlightcolor="black")
        ...
        self.udNakshatraLord.place(relx=0.021, rely=0.31, height=26, width=433
                , bordermode='ignore')
        self.udNakshatraLord.configure(activebackground="#f9f9f9")
        ...
        self.udNakshatraLord.configure(highlightbackground="#d9d9d9")
        self.udNakshatraLord.configure(highlightcolor="black")
        ...
        self.udMaasa.place(relx=0.021, rely=0.372, height=26, width=443
                , bordermode='ignore')
        self.udMaasa.configure(activebackground="#f9f9f9")
        ...
        self.udMaasa.configure(highlightbackground="#d9d9d9")
        self.udMaasa.configure(highlightcolor="black")
        ...
        self.udTithi.place(relx=0.021, rely=0.434, height=26, width=443
                , bordermode='ignore')
        self.udTithi.configure(activebackground="#f9f9f9")
        ...
        self.udTithi.configure(highlightbackground="#d9d9d9")
        self.udTithi.configure(highlightcolor="black")
        ...
        self.udVaara.place(relx=0.021, rely=0.496, height=26, width=433
                , bordermode='ignore')
        self.udVaara.configure(activebackground="#f9f9f9")
        ...
        self.udVaara.configure(highlightbackground="#d9d9d9")
        self.udVaara.configure(highlightcolor="black")
        ...
        self.udYoga.place(relx=0.021, rely=0.558, height=26, width=432
                , bordermode='ignore')
        self.udYoga.configure(activebackground="#f9f9f9")
        ...
        self.udYoga.configure(highlightbackground="#d9d9d9")
        self.udYoga.configure(highlightcolor="black")
        ...
        self.udKarana.place(relx=0.021, rely=0.62, height=26, width=442
                , bordermode='ignore')
        self.udKarana.configure(activebackground="#f9f9f9")
        ...
        self.udKarana.configure(highlightbackground="#d9d9d9")
        self.udKarana.configure(highlightcolor="black")
        ...
        self.udRutu.place(relx=0.021, rely=0.682, height=26, width=432
                , bordermode='ignore')
        self.udRutu.configure(activebackground="#f9f9f9")
        ...
        self.udRutu.configure(highlightbackground="#d9d9d9")
        self.udRutu.configure(highlightcolor="black")
        ...
        self.btnPlanetTable = tk.Button(self.Labelframe1)
        self.btnPlanetTable.place(relx=0.034, rely=0.373, height=43, width=146
                , bordermode='ignore')
        self.btnPlanetTable.configure(activebackground="beige")
        self.btnPlanetTable.configure(activeforeground="black")
        self.btnPlanetTable.configure(background="#ff9831")
        self.btnPlanetTable.configure(compound='left')
        self.btnPlanetTable.configure(disabledforeground="#a3a3a3")
        self.btnPlanetTable.configure(font="-family {Rockwell} -size 12 -weight bold")
        self.btnPlanetTable.configure(foreground="#000000")
        self.btnPlanetTable.configure(highlightbackground="#d9d9d9")
        self.btnPlanetTable.configure(highlightcolor="black")
        self.btnPlanetTable.configure(pady="0")
        self.btnPlanetTable.configure(text='''Planet Table''')
        self.btnVimshottariDasha = tk.Button(self.Labelframe1)
        self.btnVimshottariDasha.place(relx=0.288, rely=0.373, height=43
                , width=146, bordermode='ignore')
        self.btnVimshottariDasha.configure(activebackground="#5033f2")
        self.btnVimshottariDasha.configure(activeforeground="#ffffff")
        self.btnVimshottariDasha.configure(background="#baea3c")
        self.btnVimshottariDasha.configure(compound='left')
        self.btnVimshottariDasha.configure(disabledforeground="#a3a3a3")
        self.btnVimshottariDasha.configure(font="-family {Rockwell Condensed} -size 11 -weight bold")
        self.btnVimshottariDasha.configure(foreground="#000000")
        self.btnVimshottariDasha.configure(highlightbackground="#d9d9d9")
        self.btnVimshottariDasha.configure(highlightcolor="black")
        self.btnVimshottariDasha.configure(pady="0")
        self.btnVimshottariDasha.configure(text='''Vimshottari Dasha''')
        self.lblVargaFocus = tk.Label(self.Labelframe1)
        self.lblVargaFocus.place(relx=0.559, rely=0.4, height=26, width=142
                , bordermode='ignore')
        self.lblVargaFocus.configure(activebackground="#f9f9f9")
        self.lblVargaFocus.configure(anchor='w')
        self.lblVargaFocus.configure(background="#d9d9d9")
        self.lblVargaFocus.configure(compound='left')
        self.lblVargaFocus.configure(disabledforeground="#a3a3a3")
        self.lblVargaFocus.configure(font="-family {Rockwell} -size 12")
        self.lblVargaFocus.configure(foreground="#000000")
        self.lblVargaFocus.configure(highlightbackground="#d9d9d9")
        self.lblVargaFocus.configure(highlightcolor="black")
        self.lblVargaFocus.configure(text='''Focus Varga :''')
        self.cmbVarga = ttk.Combobox(self.Labelframe1)
        self.cmbVarga.place(relx=0.797, rely=0.4, relheight=0.069, relwidth=0.132
                , bordermode='ignore')
        self.cmbVarga.configure(state="readonly")
        self.value_list = ['D1','D2','D3','D4','D7','D9','D10','D12','D16','D20','D24','D27','D30','D40','D45','D60',]
        self.cmbVarga.configure(values=self.value_list)
        self.cmbVarga.configure(font="-family {Rockwell} -size 12")
        self.cmbVarga.configure(justify='center')
        self.cmbVarga.configure(textvariable=self.varga)
        self.cmbVarga.configure(takefocus="")
        self.cmbVarga.current(0)
        self.cmbVarga_tooltip = \
        ToolTip(self.cmbVarga, '''Select for which Varga the planet table and Dasha need to be computed. Default is D1. Dont forget to hit Submit button again to take effect''')
        
        #manual addition parts
        #functions of UserInput Buttons
